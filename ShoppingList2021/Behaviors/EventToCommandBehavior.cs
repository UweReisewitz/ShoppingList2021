...
namespace ShoppingList2021.Behaviors
{
    public class EventToCommandBehavior : BehaviorBase<VisualElement>
    {
        ...
        public static readonly BindableProperty EventNameProperty = BindableProperty.Create(nameof(EventName), typeof(string), typeof(EventToCommandBehavior), null, propertyChanged: EventNameChanged);
        ...
        private static void EventNameChanged(BindableObject bindable, object oldValue, object newValue)
        {
